		...
		<div class="container-fluid">
			...
			<div class="row">
				<ul class="fh5co-social">
					@if(Auth::check())
                        <li><a href="my-profile"><i >{{ Auth::User()->name }}</i></a></li>
						<li><a href="{{ route('auth.logout') }}"><i >Logout</i></a></li>
                    @else
                        <li><a href="{{ route('auth.login')}}"><i >Login</i></a></li>
						<li><a href="{{ route('auth.register')}}"><i >Register</i></a></li>
                    @endif
