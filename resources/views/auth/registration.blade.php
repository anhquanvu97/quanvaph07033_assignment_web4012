                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('auth.registration') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="date_of_birth" type="date" class="form-control @error('date_of_birth') is-invalid @enderror" name="date_of_birth"  required autocomplete="date_of_birth" autofocus>
                            </div>
                        </div>
                        <div class="form-group row">
